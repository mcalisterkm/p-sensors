# Modified to run as a background task collecting data for a specified time
    ...
    def record_data(self):
        ...
        while(True):
            ...
            try:
                ...
                # Default is to run the sensor for 1 hour then write out the data
                # 1 hours in seconds is 3600
                # 1.5 hours in seconds is 5400
                # 30 min  in seconds is 1800
